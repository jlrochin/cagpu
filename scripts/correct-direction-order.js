...
async function correctDirectionOrder() {
    try {
        console.log('🔄 Corrigiendo orden de las direcciones según la imagen...\n');
        ...
        console.log('📋 Estableciendo orden correcto (de izquierda a derecha):');
        ...
        console.log('\n🎉 ¡Orden de direcciones corregido según la imagen!');
        console.log('Ahora aparecerán en el orden correcto: Administración → Desarrollo → Enfermería → Investigación → General → Médica');
