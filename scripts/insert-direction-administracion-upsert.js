...
async function insertDirectionAdministracion() {
  try {
    ...
    // Lista de servicios de la Dirección de Administración (con campos acortados)
    const servicios = [
    ...
    console.log(`🔄 Creando/actualizando ${servicios.length} servicios...`);
    
    // Crear o actualizar todos los servicios usando upsert
