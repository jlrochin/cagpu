...
async function setGeneralMedicaInvestigacionDesarrollo() {
  try {
    console.log('🔄 Configurando orden: General → Médica → Investigación → Desarrollo...\n');

    // Orden con las primeras 4 direcciones configuradas
    const newOrder = [
      {
...
setGeneralMedicaInvestigacionDesarrollo();
