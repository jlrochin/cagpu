...
async function setGeneralMedicaInvestigacionDesarrolloAdministracion() {
    try {
        console.log('🔄 Configurando orden: General → Médica → Investigación → Desarrollo → Administración...\n');

        // Orden con las primeras 5 direcciones configuradas
        const newOrder = [
            {
        ...
        console.log('Orden: General → Médica → Investigación → Desarrollo → Administración → Enfermería');
...
setGeneralMedicaInvestigacionDesarrolloAdministracion();
